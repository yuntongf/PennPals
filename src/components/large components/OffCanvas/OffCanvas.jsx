   ...
   if (message === null) return;
      ...
      return (
         <div className="col-10 d-flex justify-content-start p-2">
            <div className="offcanvas show offcanvas-end border-0 bg-transparent pe-5 me-4" style={{ width: "40%" }} data-bs-scroll="true" data-bs-backdrop="false" tabIndex="-1" id="reply" aria-labelledby="offcanvasScrollingLabel">
